<template>
    <div class="flex justify-start items-center bg-[#a2d2ff]">
        ...
        <div class="w-full h-screen md:w-[50%] py px-10 flex flex-col justify-evenly">
            ...
            <div class="flex flex-col gap-3">
                ...
                <p class="text-xl">Don't have an account? <span>
                        <RouterLink class="text-[#6a63ac] underline hover:opacity-80 hover:cursor-pointer" to="/signup">Sign up</RouterLink>
                    </span></p>
            </div>
            <div class="flex flex-col gap-3">
            ...
            <form action="" class="flex flex-col gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <p class=" text-[#25223a] text-right hover:opacity-80 hover:cursor-pointer">forgot your password?</p>
                </div>
                <button @click.prevent="login" class="mt-4 bg-[#25223a] hover:bg-[#353150] text-white h-14 rounded-3xl">Log in</button>
            </form>
        ...
        <div class="circuit md:w-[50%] hidden md:flex h-screen"></div>
    </div>
</template>
